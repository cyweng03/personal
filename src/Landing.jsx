      ...
      <section id="Experiences">
        <div className="h-screen space-y-10">
          ...
          <div className="justify-center space-y-[5%] h-[80%]">
            <Current img={AguaClara} paragraphContent="I am currently working on a project to build a new website for my organization. 
            ...
            <div className = "flex flex-row space-x-[8%] h-[45%]">
              <Project img={CirrusData} paragraphContent="I assisted in the development of a cloud lab SaaS testbed environment, which 
              ...
              machines."/>
              <Project img={Research} paragraphContent="I am the sole author of a research paper published in an academic journal. In this 
              ...
              in a clear and concise manner." link="https://www.scirp.org/journal/paperinformation.aspx?paperid=119165"/>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-row">
              <div className="flex flex-col mr-10">
                ...
                <div className="text-lg mt-5 mb-2">
                  I am currently a student at Cornell University with a passion for 
                  developing innovative software solutions.
                </div>

                <div className="text-lg mt-5 mb-2">
                  My passion for technology was influenced by my dad, who 
                  works in the field. I am a team player and I am always willing to 
                  learn new things. I am particularly interested in web and 
                  backend development, and I am excited to explore the potential of 
                  these technologies to solve real-world problems.
                  
                </div>
                <div className="text-lg mt-5 mb-2">
                  I'm inspired by people who use design to solve real-world problems
                  and make a positive impact on the world. If that sounds like you, 
                  <a href="https://www.linkedin.com/in/chuyinweng/" className="text-blue-600 font-bold"> lets connect!</a>
                </div>
